...
SDL_PROC(void, glBindBufferBase, (GLenum, GLuint, GLuint))
SDL_PROC(void*, glMapBufferRange, (GLenum, GLintptr, GLsizeiptr, GLbitfield))
SDL_PROC(GLboolean, glUnmapBuffer, (GLenum target))
SDL_PROC(void, glBindImageTexture, (GLuint, GLuint, GLint, GLboolean, GLint, GLenum, GLenum))
SDL_PROC(void, glDispatchCompute, (GLuint, GLuint, GLuint))
SDL_PROC(void, glMemoryBarrier, (GLbitfield))
